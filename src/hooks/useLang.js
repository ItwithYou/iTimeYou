...
const translations = {
  en: {
    ...
    getStarted: 'Get Started', explore: 'Explore',
    feed: 'Feed', trips: 'Trips', wallet: 'Wallet', messages: 'Messages', profile: 'Profile', logout: 'Logout',
    ...
    bookingsTitle: 'My Bookings', noBookings: 'No bookings yet',
  ...
  lo: {
    ...
    getStarted: 'ເລີ່ມຕົ້ນ', explore: 'ສຳຫຼວດ',
    feed: 'ຟີດ', trips: 'ການເດີນທາງ', wallet: 'ກະເປົາ', messages: 'ຂໍ້ຄວາມ', profile: 'ໂປຣໄຟລ໌', logout: 'ອອກ',
    ...
    bookingsTitle: 'ການຈອງຂອງຂ້ອຍ', noBookings: 'ຍັງບໍ່ມີການຈອງ',
