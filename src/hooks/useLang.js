...
const translations = {
  en: {
    ...
    feed: 'Personal', trips: 'Trips', wallet: 'Wallet', messages: 'Messages', profile: 'Profile', logout: 'Logout',
  ...
  lo: {
    ...
    feed: 'ສ່ວນຕົວ', trips: 'ການເດີນທາງ', wallet: 'ກະເປົາ', messages: 'ຂໍ້ຄວາມ', profile: 'ໂປຣໄຟລ໌', logout: 'ອອກ',
