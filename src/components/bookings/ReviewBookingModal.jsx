...
export default function ReviewBookingModal({ booking, currentUser, lang, onClose, onReviewSubmitted }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await base44.entities.Listing.update(booking.listing_id, {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-end sm:items-center justify-center p-4" onClick={onClose}>
      <div className="bg-card w-full max-w-md rounded-t-3xl sm:rounded-2xl p-6 border border-border shadow-2xl" onClick={(e) => e.stopPropagation()}>
